...
async function runMigration() {
    console.log('🚀 Running migration for is_online...');
    const sqlPath = path.join(__dirname, 'add_online_status.sql');
    ...
    if (error) {
        ...
        console.log('✅ Migration successful! is_online column added.');
    }
}
